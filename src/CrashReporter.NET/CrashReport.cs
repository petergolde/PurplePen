    ...
    internal partial class CrashReport : Form
    {
        ...
        private string CreateReport(Exception exception)
        {
            string report = string.Format(@"<br/>
                        ...
                        </div>", WebUtility.HtmlEncode(exception.GetType().ToString()),
                                          WebUtility.HtmlEncode(exception.Message),
                                          WebUtility.HtmlEncode(exception.Source),
                                          WebUtility.HtmlEncode(exception.StackTrace).Replace("\r\n", "<br/>"));
        ...
        private void CrashReportLoad(object sender, EventArgs e)
        {
            ...
            labelIntro.Text = _reportCrash.TextIntro;
            labelEmail.Text = _reportCrash.TextEmail;
