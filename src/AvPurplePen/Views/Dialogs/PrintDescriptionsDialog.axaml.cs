...
//   3. The Change Printer… / Change Margins… / Preview buttons, which
//      aren't ported yet — their click handlers are intentionally no-ops
//      (with a TODO inside #if PORTING for the future port).
//
