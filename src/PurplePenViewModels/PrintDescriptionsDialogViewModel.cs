...
namespace PurplePen.ViewModels
{
    ...
    public partial class PrintDescriptionsDialogViewModel : ViewModelBase
    {
        ...
        /// <summary>
        /// Paper size + margins. Displayed via <see cref="PaperSizeDisplay"/>,
        /// <see cref="OrientationDisplay"/>, and <see cref="MarginsDisplay"/>;
        /// edited via the Change Margins… button (<see cref="ChangeMarginsCommand"/>),
        /// which opens the Page Setup dialog. Round-trips unchanged if not edited.
        /// </summary>
        [ObservableProperty]
